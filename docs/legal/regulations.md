...
Прежде, чем подать заявку в службу поддержки, следует  ознакомиться с инструкцией к программе. Ответы на стандартные, часто задаваемые вопросы даны в руководстве пользователя программного обеспечения iStom по ссылке: [http://support.i-stom.ru](http://support.i-stom.ru/)
...
    - [https://i-stom.ru](https://i-stom.ru/)
    - [https://cloud.i-stom.ru](https://cloud.i-stom.ru/)
    - [http://support.i-stom.ru](http://support.i-stom.ru/)
