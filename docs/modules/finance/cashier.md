...
Для того, чтобы сделать выгрузку, необходимо зайти в пункт \"Ведомости\" в меню слева и после этого выбрать раздел \"Организация\". Далее Вам нужно выбрать период в открывшемся окне сверху. Для печати ведомости необходимо нажать кнопку \"Печать\" (![\1](../../images/media/image1.png)).
