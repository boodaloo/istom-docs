...
## Как добавить скидку в счёт пациента

#### Как пациенту можно добавить скидку в счёт?

В левом меню выбираем раздел "Карта пациента", переходим в "Счет пациента" — внизу окна слева располагается поле скидки. Если её невозможно проставить — нужно предоставить соответствующий доступ данному пользователю (возможно, у него нет прав доступа).

Скидку можно проставить по:
- **рекламной компании**
- **группе скидок**
- **мультипрайсу**

При оформлении счета можно выбрать процентную ставку или сумму, изменив сумму по прайс-листу.

---

## Возможна ли скидка отдельно по специализации в плане лечения

#### Возможно ли в плане лечения сделать скидку отдельно по специализации?

Нет, скидку можно сделать только на план лечения в общем. Данная функция планируется в следующих версиях программы.

---

## Как сменить врача при формировании счёта

#### Как сменить врача при формировании счёта за услуги?

Для смены врача необходимо, чтобы в меню "Карта пациента" во вкладке "Лечащие врачи" уже был врач такой же специальности — врачи меняются **только в рамках одной специализации** (например, терапевт на терапевта).
