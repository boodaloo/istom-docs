...
![](../../images/extracted/ЕГИСЗ/image5.png) <br> <!-- Авторизация в iStom, окно ввода кредов -->
...
![](../../images/extracted/ЕГИСЗ/image6.png) <br> <!-- Авторизация в iStom, окно ввода кредов, успешная авторизация -->

3. После завершения авторизации открывается окно параметров отправки данных в ЕГИСЗ:

![](../../images/extracted/ЕГИСЗ/image7.png) <br> <!-- Параметры отправки данных в систему ЕГИСЗ -->
...
![](../../images/extracted/ЕГИСЗ/image8.png) <br> <!-- Параметры отправки данных в систему ЕГИСЗ. Блок пациента -->
...
![](../../images/extracted/ЕГИСЗ/image9.png) <br> <!-- Полный список, доступных к выбору типов документа -->
 
### **Доверенное лицо:**
*(если окно открыто из карты пациента, имеющего представителя (раздел поручительство))*

![](../../images/extracted/ЕГИСЗ/image10.png) <br> <!-- Параметры отправки данных в систему ЕГИСЗ. Блок поручителя -->
...
![](../../images/extracted/ЕГИСЗ/image11.png) <br> <!-- Полный список, доступных к выбору отношений к пациенту -->

<br><br>

## **Врачебный блок (состоит из двух вкладок):**

![](../../images/extracted/ЕГИСЗ/image12.png) <br> <!-- Параметры отправки данных в систему ЕГИСЗ. Врачебный блок. Вкладка "Данные - врач" -->
...
![](../../images/extracted/ЕГИСЗ/image13.png) <br> <!-- Параметры отправки данных в систему ЕГИСЗ. Врачебный блок. Вкладка "Данные - пользователь ЕГИСЗ" -->
...
![](../../images/extracted/ЕГИСЗ/image16.png) <br> <!-- Параметры отправки данных в систему ЕГИСЗ. Блок результатов приёма -->
...
![](../../images/extracted/ЕГИСЗ/image22.png) <br> <!--  -->
...
![](../../images/extracted/ЕГИСЗ/image23.png) <br> <!--  -->
...
![](../../images/extracted/ЕГИСЗ/image24.png)  <!-- Справочник кодов МКБ10 1 часть -->
![](../../images/extracted/ЕГИСЗ/image25.png)  <!-- Справочник кодов МКБ10 2 часть -->
![](../../images/extracted/ЕГИСЗ/image26.png)  <!-- Справочник кодов МКБ10 3 часть -->
![](../../images/extracted/ЕГИСЗ/image27.png)  <!-- Справочник кодов МКБ10 4 часть -->
![](../../images/extracted/ЕГИСЗ/image28.png)  <!-- Справочник кодов МКБ10 5 часть -->
![](../../images/extracted/ЕГИСЗ/image29.png)  <!-- Справочник кодов МКБ10 6 часть -->
![](../../images/extracted/ЕГИСЗ/image30.png)  <!-- Справочник кодов МКБ10 7 часть -->
![](../../images/extracted/ЕГИСЗ/image31.png)  <!-- Справочник кодов МКБ10 8 часть -->
<br>
