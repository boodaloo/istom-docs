...
<div align="center">
  <img src="../../images/extracted/ЕГИСЗ/image1.png">
</div>
...
!!! info "Обратите внимание" ИНФОРМАЦИЯ НА СКРИНШОТАХ ЯВЛЯЕТСЯ ОЗНАКОМИТЕЛЬНОЙ И ПРЕДНАЗНАЧЕНА ДЛЯ ВИЗУАЛЬНОГО ПРЕДСТАВЛЕНИЯ О ТОМ, КАК ВЫГЛЯДИТ ИНТЕРФЕЙС ПРОГРАММЫ.
ДЛЯ КОРРЕКТНОЙ НАСТРОЙКИ И ИСПОЛЬЗОВАНИЯ ФУНКЦИОНАЛА ЧИТАЙТЕ ОПИСАНИЕ!
...
- [Отправка данных о приеме несовершеннолетнего пациента](workflow-child) - краткая инструкция по отправке данных о приеме несовершеннолетнего пациента, имеющего поручителя.
