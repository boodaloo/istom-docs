...
Закрываем. Настройка завершена. Проводим оплату. Для каждой специализации на данного врача выставляется отдельный счет. Счет отобразится в ведомости только после первой оплаты или внесения пациентом аванса или полной оплаты счета.![\1](../images/media/image4.png)
