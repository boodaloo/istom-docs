...
Основной персонал и младший персонал. В разделе основной персонал мы настраиваем вид зарплаты, процентную ставку и оклад, если он есть. В разделе "Младший персонал" выбираем вид оплаты, ставим оклад и стоимость зарплаты за один снимок.
...
![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image1.png)

Выберите вид оплаты, с которого сотрудник будет получать процент.

![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image2.png)

Укажите процент, либо оклад. В случае, если вид оплаты выбран "От суммы без скидки + оклад" - укажите и оклад, и процент.

![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image3.png)
...
![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image4.png)
...
![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image5.png)

Для просмотра зарплат младшего персонала - откройте соответствующий пункт "Младший персонал".

Для добавления записи о выплате оклада младшему сотруднику - нажмите +, выберите сотрудника, а затем заполните недостающие поля. (В случае Ассистента и медсестры, если вы ведёте график работы данных сотрудников через расписание - тогда начисления по их зарплате будут отображаться в данном разделе автоматически)

![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image6.png)
...
![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image7.png)
...
![](../images/extracted/Зарплата_врачей_и_младшего_персонала/image8.png)
...
## Вычет стоимости материала из зарплаты врача

Возможность вычета стоимости материала или прочего из зарплаты врача при оплате по счету конкретного пациента доступна в версии iStom 2.2 и выше.
