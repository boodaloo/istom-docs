...
![\1](../images/media/image1.png) - Создание документа, карты, счета и прочего или добавления данных фото, основного уровня в ведомостях, настройках и шаблонах, и прочих данных.

![\1](../images/media/image2.png) - Добавление подуровня в ведомостях, настройках и шаблонах.

![\1](../images/media/image3.png) - Удаление. В некоторых разделах программы iStom, удаление доступно по нажатию правой кнопки мыши.

![\1](../images/media/image4.png) - Вывод на печать документов и экспорт в 1С и другие форматы. Во многих разделах программы iStom, имеется выбор что нужно вывести на печать.

![\1](../images/media/image5.png) - Экспорт печатных форм в 1С и другие форматы. Кнопка доступна после нажатия кнопки принтера (печати).

![\1](../images/media/image6.png) - Увеличение/уменьшение печатных форм для удобства их просмотра.

![\1](../images/media/image7.png) - Переключение между страницами в печатных формах, а также кнопки перехода в начало и конец документа.

![\1](../images/media/image8.png) - Редактирование данных.

![\1](../images/media/image9.png) - Шаблоны, прайс-листы и прочие списки с данными для заполнения разделов программы.

![\1](../images/media/image10.png) - Формирование счетов из плана лечения.

![\1](../images/media/image11.png) - Подписанные пациентом документы (кнопка добавляется автоматом после вывода на печать первого подписанного документа).

![\1](../images/media/image12.png) - Пополнение баланса пациента.

![\1](../images/media/image13.png) - Проведение оплаты в текущем счете и ведомостях.

![\1](../images/media/image14.png) - Кнопка показа списка событий для выбранного пациента в расписании. (кнопка доступна в административной вкладке карты пациента).

![\1](../images/media/image15.png) - кнопка звонка.
